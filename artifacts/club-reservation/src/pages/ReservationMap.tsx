...
const LAYOUT: TableDef[] = [
  ...
  // ── F-TABLES LEFT ──
  { id: "f7",  label: "F7",  bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 235, top: 263, width: 40, height: 40 },
  { id: "f12", label: "F12", bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 300, top: 263, width: 40, height: 40 },
  { id: "f8",  label: "F8",  bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 235, top: 324, width: 40, height: 40 },
  { id: "f6",  label: "F6",  bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 173, top: 368, width: 40, height: 40 },
  { id: "f9",  label: "F9",  bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 235, top: 391, width: 40, height: 40 },
  { id: "f5",  label: "F5",  bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 173, top: 427, width: 40, height: 40 },
  { id: "f10", label: "F10", bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 235, top: 465, width: 40, height: 40 },
  { id: "f4",  label: "F4",  bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 173, top: 485, width: 40, height: 40 },
  { id: "f11", label: "F11", bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 235, top: 538, width: 40, height: 40 },
  ...
  { id: "f16", label: "F16", bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 496, top: 334, width: 40, height: 40 },
  { id: "f17", label: "F17", bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 496, top: 401, width: 40, height: 40 },
  { id: "f20", label: "F20", bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 558, top: 353, width: 40, height: 40 },
  { id: "f18", label: "F18", bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 496, top: 475, width: 40, height: 40 },
  { id: "f21", label: "F21", bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 558, top: 419, width: 40, height: 40 },
  { id: "f19", label: "F19", bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 496, top: 548, width: 40, height: 40 },
