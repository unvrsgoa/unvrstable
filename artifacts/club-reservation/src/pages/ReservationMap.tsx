...
const LAYOUT: TableDef[] = [
  ...
  { id: "gold1", label: "GOLD 1",      bgColor: GOLD,     left:  60, top: 174, width: 82, height: 55 },
  { id: "gold2", label: "GOLD 2",      bgColor: GOLD,     left: 147, top: 174, width: 82, height: 55 },
  { id: "gold3", label: "GOLD\nVIP 3", bgColor: VIP_GOLD, left: 234, top: 174, width: 82, height: 55 },
