...
const LAYOUT: TableDef[] = [
  ...
  { id: "d9",  label: "D9",  bgColor: D_TABLE, fontSize: "min(1.2vw,9px)", left: 498, top: 426, width: 38, height: 38 },
  { id: "d10", label: "D10", bgColor: D_TABLE, fontSize: "min(1.2vw,9px)", left: 542, top: 426, width: 38, height: 38 },
