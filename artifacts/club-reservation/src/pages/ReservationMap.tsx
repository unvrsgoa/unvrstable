...
const LAYOUT: TableDef[] = [
  ...
  { id: "s1",  label: "S1",   bgColor: S_TABLE, left: 307, top: 412, width: 46, height: 36 },
  { id: "s2",  label: "S2",   bgColor: S_TABLE, left: 363, top: 412, width: 46, height: 36 },
  { id: "s3",  label: "S3",   bgColor: S_TABLE, left: 307, top: 462, width: 46, height: 36 },
  { id: "s4",  label: "S4",   bgColor: S_TABLE, left: 363, top: 462, width: 46, height: 36 },
  { id: "s5",  label: "S5",   bgColor: S_TABLE, left: 307, top: 512, width: 46, height: 36 },
  { id: "s6",  label: "S6",   bgColor: S_TABLE, left: 363, top: 512, width: 46, height: 36 },
  { id: "s7",  label: "S7",   bgColor: S_TABLE, left: 307, top: 562, width: 46, height: 36 },
  { id: "s8",  label: "S8",   bgColor: S_TABLE, left: 363, top: 562, width: 46, height: 36 },
