...
const LAYOUT: TableDef[] = [
  ...
  // ── F-TABLES LEFT ──
  { id: "f7",  label: "F7",  bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 238, top: 255, width: 40, height: 40 },
  { id: "f12", label: "F12", bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 255, top: 240, width: 40, height: 40 },
  { id: "f8",  label: "F8",  bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 245, top: 316, width: 40, height: 40 },
  { id: "f6",  label: "F6",  bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 173, top: 368, width: 40, height: 40 },
  { id: "f9",  label: "F9",  bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 245, top: 383, width: 40, height: 40 },
  { id: "f5",  label: "F5",  bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 173, top: 427, width: 40, height: 40 },
  { id: "f10", label: "F10", bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 245, top: 457, width: 40, height: 40 },
  { id: "f4",  label: "F4",  bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 173, top: 485, width: 40, height: 40 },
  { id: "f11", label: "F11", bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 245, top: 530, width: 40, height: 40 },
