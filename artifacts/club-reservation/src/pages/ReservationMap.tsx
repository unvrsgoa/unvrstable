...
const LAYOUT: TableDef[] = [
  ...
  { id: "f3",  label: "F3",  bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 173, top: 612, width: 40, height: 40 },
  { id: "f2",  label: "F2",  bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 173, top: 670, width: 40, height: 40 },
  { id: "f1",  label: "F1",  bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 173, top: 728, width: 40, height: 40 },
