...
const LAYOUT: TableDef[] = [
  ...
  { id: "f12a", label: "F12\nA", bgColor: F_TABLE, fontSize: "min(1.1vw,8px)", left: 285, top: 340, width: 38, height: 38 },
  { id: "f12b", label: "F12\nB", bgColor: F_TABLE, fontSize: "min(1.1vw,8px)", left: 285, top: 398, width: 38, height: 38 },
