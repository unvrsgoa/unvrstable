...
const LAYOUT: TableDef[] = [
  ...
  { id: "d1",  label: "D1",  bgColor: D_TABLE, fontSize: "min(1.2vw,9px)", left: 179, top: 857, width: 38, height: 38 },
  { id: "d2",  label: "D2",  bgColor: D_TABLE, fontSize: "min(1.2vw,9px)", left: 222, top: 857, width: 38, height: 38 },
