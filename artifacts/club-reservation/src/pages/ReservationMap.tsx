...
const LAYOUT: TableDef[] = [
  ...
  { id: "s1",  label: "S1",   bgColor: S_TABLE, left: 305, top: 408, width: 54, height: 44 },
  { id: "s2",  label: "S2",   bgColor: S_TABLE, left: 369, top: 408, width: 54, height: 44 },
  { id: "s3",  label: "S3",   bgColor: S_TABLE, left: 305, top: 460, width: 54, height: 44 },
  { id: "s4",  label: "S4",   bgColor: S_TABLE, left: 369, top: 460, width: 54, height: 44 },
  { id: "s5",  label: "S5",   bgColor: S_TABLE, left: 305, top: 512, width: 54, height: 44 },
  { id: "s6",  label: "S6",   bgColor: S_TABLE, left: 369, top: 512, width: 54, height: 44 },
  { id: "s7",  label: "S7",   bgColor: S_TABLE, left: 305, top: 564, width: 54, height: 44 },
  { id: "s8",  label: "S8",   bgColor: S_TABLE, left: 369, top: 564, width: 54, height: 44 },
