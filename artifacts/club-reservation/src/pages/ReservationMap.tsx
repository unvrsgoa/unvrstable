...
const LAYOUT: TableDef[] = [
  ...
  { id: "f14a", label: "F14\nA", bgColor: F_TABLE, fontSize: "min(1.1vw,8px)", left: 440, top: 360, width: 38, height: 38 },
  { id: "f14b", label: "F14\nB", bgColor: F_TABLE, fontSize: "min(1.1vw,8px)", left: 440, top: 418, width: 38, height: 38 },
