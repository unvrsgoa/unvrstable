...
const LAYOUT: TableDef[] = [
  ...
  { id: "f12a", label: "F12\nA", bgColor: F_TABLE, fontSize: "min(1.1vw,8px)", left: 295, top: 325, width: 38, height: 38 },
  { id: "f12b", label: "F12\nB", bgColor: F_TABLE, fontSize: "min(1.1vw,8px)", left: 295, top: 383, width: 38, height: 38 },
  { id: "f14a", label: "F14\nA", bgColor: F_TABLE, fontSize: "min(1.1vw,8px)", left: 340, top: 430, width: 38, height: 38 },
  { id: "f14b", label: "F14\nB", bgColor: F_TABLE, fontSize: "min(1.1vw,8px)", left: 340, top: 488, width: 38, height: 38 },
