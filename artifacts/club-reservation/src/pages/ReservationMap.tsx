...
const LAYOUT: TableDef[] = [
  ...
  { id: "f14a", label: "F14\nA", bgColor: F_TABLE, fontSize: "min(1.1vw,8px)", left: 450, top: 340, width: 38, height: 38 },
  { id: "f14b", label: "F14\nB", bgColor: F_TABLE, fontSize: "min(1.1vw,8px)", left: 450, top: 398, width: 38, height: 38 },
  ...
  { id: "f14", label: "F14", bgColor: F_TABLE, fontSize: "min(1.2vw,9px)", left: 452, top: 263, width: 40, height: 40 },
  ...
  { id: "d2",  label: "D2",  bgColor: D_TABLE, fontSize: "min(1.2vw,9px)", left: 202, top: 897, width: 38, height: 38 },
  { id: "d3",  label: "D3",  bgColor: D_TABLE, fontSize: "min(1.2vw,9px)", left: 255, top: 807, width: 38, height: 38 },
  { id: "d4",  label: "D4",  bgColor: D_TABLE, fontSize: "min(1.2vw,9px)", left: 318, top: 807, width: 38, height: 38 },
  { id: "d5",  label: "D5",  bgColor: D_TABLE, fontSize: "min(1.2vw,9px)", left: 311, top: 807, width: 38, height: 38 },
