...
const BASE_TABLES: Array<{ id: string; status: string; price: string }> = [
  ...
  { id: "f12a", status: "available", price: "50K" },
  { id: "f12b", status: "available", price: "50K" },
  { id: "f14a", status: "available", price: "50K" },
  { id: "f14b", status: "available", price: "50K" },
  ...
  { id: "s6",  status: "available", price: "50K" },
  { id: "s7",  status: "available", price: "50K" },
  { id: "s8",  status: "available", price: "50K" },
